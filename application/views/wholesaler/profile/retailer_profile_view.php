                                            ...
                                            <div id="home" class="tab-pane in active">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-3 center">
                                                        <?php if (($retailer_profile->profile_pic) == NULL) :

                                                            $path_of_image = 'avatar_placeholder1.png';
                                                        else:
                                                            $path_of_image = $retailer_profile->profile_pic;

                                                        endif; ?>


															<span class="profile-picture">
																<img class="editable img-responsive" alt="<?php echo $retailer_profile->username; ?>"
                                                                     id="avatar2"
                                                        ...
                                                        <i href="#" class="btn btn-sm btn-block btn-success">
                                                            ...
                                                            <span class="bigger-110"><?php echo $retailer_profile->fullname; ?></span>
                                                        </i>
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <h4 class="blue">
                                                            <span class="middle"><?php echo $retailer_profile->fullname; ?></span>
                                                            <?php if ($retailer_profile->verified == 'YES'): ?>
                                                        ...
                                                        <div class="profile-user-info">
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    <span><?php echo $retailer_profile->username; ?></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    ...
                                                                    <span><?php echo $retailer_profile->location; ?></span>
                                                            ...
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    <span><?php echo $retailer_profile->contact_no; ?></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    <span><?php echo date("d/m/Y", strtotime($retailer_profile->date_created)); ?></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    <span><?php echo $retailer_profile->email; ?></span>
                                                                </div>
                                                            </div>
