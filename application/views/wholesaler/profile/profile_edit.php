                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <?php echo form_open_multipart('', "class='form-horizontal'"); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-4"> Description
                                    </label>

                                    <div class="col-sm-9">
                                        <textarea name="description" id="form-field-4"  rows="5" class="col-xs-10 col-sm-5"><?php echo $user_profile->description; ?></textarea>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"> Logo
                                         </label>
