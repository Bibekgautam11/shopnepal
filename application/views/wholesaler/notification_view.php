                ...
                <a href="<?php echo base_url('wholesaler/notifications'); ?>">
                    ...
                    <span class="menu-text">
								...
								<span class="badge badge-transparent tooltip-error"
                                      title="<?php echo count($unread_notifications); ?> Important Events">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-collapse collapse"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <p>
                                                                <a href="<?php echo base_url('wholesaler/notifications/mark_as_read/' . $unread_notification->id); ?>"
                                                                   class="btn btn-white btn-info btn-bold">
                                                                    <i class="ace-icon fa fa-reddit-alien bigger-120 blue"></i>
                                                                    Mark as read
                                                                </a>

                                                                <a href="<?php echo base_url('wholesaler/notifications/delete/' . $unread_notification->id); ?>"
                                                                ...
                                                                <a href="<?php echo base_url('wholesaler/notifications/archive/' . $unread_notification->id); ?>"
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-collapse collapse"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="clearfix"></div>
                                                            <p>
                                                                <a href="<?php echo base_url('wholesaler/notifications/mark_as_unread/' . $read_notification->id); ?>"
                                                                   class="btn btn-white btn-info btn-bold">
                                                                    <i class="ace-icon fa fa-reddit-alien bigger-120 blue"></i>
                                                                    Mark as Unread
                                                                </a>

                                                                <a href="<?php echo base_url('wholesaler/notifications/delete/' . $read_notification->id); ?>"
                                                                   class="btn btn-white btn-warning btn-bold" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');">
                                                                    <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>
                                                                    Delete
                                                                </a>

                                                                <a href="<?php echo base_url('wholesaler/notifications/archive/' . $read_notification->id); ?>"
                                                                   class="btn btn-white btn-default btn-round">
                                                                    <i class="ace-icon fa fa-times red2"></i>
                                                                    Archive
                                                                </a>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-collapse collapse"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="clearfix"></div>
                                                            <p>
                                                                <a href="<?php echo base_url('wholesaler/notifications/mark_as_unread/' . $archived_notification->id); ?>"
                                                                   class="btn btn-white btn-info btn-bold">
                                                                    <i class="ace-icon fa fa-reddit-alien bigger-120 blue"></i>
                                                                    Mark as Unread
                                                                </a>

                                                                <a href="<?php echo base_url('wholesaler/notifications/mark_as_read/' . $archived_notification->id); ?>"
                                                                   class="btn btn-white btn-default btn-round">
                                                                    <i class="ace-icon fa fa-reddit red2"></i>
                                                                    Mark as Read
                                                                </a>

                                                                <a href="<?php echo base_url('wholesaler/notifications/delete/' . $archived_notification->id); ?>"
                                                                   class="btn btn-white btn-warning btn-bold" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');">
                                                                    <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>
                                                                    Delete
                                                                </a>
