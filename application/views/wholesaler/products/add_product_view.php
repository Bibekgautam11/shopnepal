                                ...
                                <div class="step-pane active">
                                    ...
                                    <?php echo form_open_multipart('', "class='form-horizontal'"); ?>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div class="clearfix">
                                                    <input type="text" name="product_name" id="product_name"
                                                           maxlength="30"   class="col-xs-12 col-sm-6" placeholder="Product Name" value="<?php echo set_value('product_name'); ?>"required/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div class="clearfix">
                                                    <input type="number" name="price" id="price" placeholder="Price In Rs"
                                                           class="col-xs-12 col-sm-2" min="0" value="<?php echo set_value('price'); ?>" required/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div class="clearfix">
                                                    <input type="number" name="quantity" id="quantity"
                                                           class="col-xs-12 col-sm-2" min="0" placeholder="Number of Items" value="<?php echo set_value('quantity'); ?>" required/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div class="clearfix">
                                                    <textarea class="input-xxlarge" name="description" maxlength="500"
                                                              id="description"  required><?php echo set_value('description'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div>
                                                    <label class="line-height-1 blue">
                                                        <input name="available" value="YES" type="radio" class="ace" checked/>
                                                ...
                                                <div>
                                                    <label class="line-height-1 blue">
                                                        <input name="available" value="NO" type="radio" class="ace" />
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <div class="clearfix">
                                                    <input type="number" name="discount" id="discount"
                                                           ...
                                                           placeholder="Leave empty for no Discount" min="0" value="<?php echo set_value('discount'); ?>"/>
                                                </div>
                                            </div>
                                        </div>
