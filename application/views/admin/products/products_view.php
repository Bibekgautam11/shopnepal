                                        ...
                                        if(count($products) != 0):
                                            ...
                                            foreach ($products as $product):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('admin/products/detail_product/'.$product->prid); ?>"><?php echo $product->product_name; ?></a>
                                                    </td>
                                                    <td><a href="<?php echo base_url('admin//users/detail_wholesaler/'.$product->whid); ?>"><?php echo $product->fullname; ?></a></td>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="blue" href="<?php echo base_url('admin/products/detail_product/'.$product->prid); ?>">
                                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>


                                                            <a class="red" href="<?php echo base_url('admin/products/delete_product/'.$product->prid); ?>"
