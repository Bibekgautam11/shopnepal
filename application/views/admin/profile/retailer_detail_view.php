        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/users/retailer');?>">Retails</a>
                    </li>
                    <li class="active">Detail Retailer</li>
                </ul><!-- /.breadcrumb -->
            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-3 center">
                                                    ...
                                                    <?php if ($user_profile->verified == 'YES'): ?>
                                                        <a href="<?php echo base_url('admin/users/unverify_retailer/'. $user_profile->id) ;?>" class="btn btn-sm btn-block btn-danger">
                                                            <i class="ace-icon bigger-120"></i>
                                                            <span class="bigger-110"><?php echo "Remove Verification"; ?></span>
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="<?php echo base_url('admin/users/verify_retailer/'. $user_profile->id) ;?>" class="btn btn-sm btn-block btn-success">
                                                            <i class="ace-icon bigger-120"></i>
