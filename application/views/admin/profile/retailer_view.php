                            ...
                            <div class="col-xs-12">
                                ...
                                <div>
                                    <table id="dynamic-table"
                                        ...
                                        <tbody>
                                        <?php
                                        if(count($retailer_profiles) != 0):

                                            foreach ($retailer_profiles as $retailer_profile):?>
                                                <tr>
                                                    <td class="center">
                                                        <label class="pos-rel">
                                                        </label>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('admin/users/detail_retailer/'.$retailer_profile->id); ?>"><?php echo $retailer_profile->fullname; ?></a>
                                                    </td>
                                                    <td><?php echo $retailer_profile->contact_no; ?></td>
                                                    <td class="hidden-480"><?php echo $retailer_profile->email; ?></td>
                                                    <td><?php echo $retailer_profile->date_created; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="blue" href="<?php echo base_url('admin/users/detail_retailer/'.$retailer_profile->id); ?>">
                                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>

                                                            <a class="red" href="<?php echo base_url('admin/users/delete_retailer/'.$retailer_profile->id); ?>"
