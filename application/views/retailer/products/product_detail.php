            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url('retailer/products');?>">Products</a>
                        </li>
                                            ...
                                            <div id="home" class="tab-pane in active">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-3 center">
                                                        ...
                                                        <?php if($already == 'NO'): ?>
                                                        <a href="<?php echo base_url('retailer/wishlists/add/'. $product->id );?>" class="btn btn-sm btn-block btn-grey">
                                                            <i class="ace-icon bigger-120"></i>
                                                            <span class="bigger-110">Add To Wishlist : <?php echo $product->product_name; ?></span>
                                                        </a>
                                                        <?php else: ?>
                                                        <a href="<?php echo base_url('retailer/wishlists/remove/'. $product->id );?>" class="btn btn-sm btn-block btn-danger">
                                                            <i class="ace-icon bigger-120"></i>
                                                            <span class="bigger-110">Remove From Wishlist : <?php echo $product->product_name; ?></span>
                                                        </a>
                                                        <?php endif; ?>
                                                        ...
                                                        <div class="profile-user-info">
                                                            <div class="profile-info-row">
                                                                ...
                                                                <div class="profile-info-value">
                                                                    <a href="<?php echo base_url('retailer/users/get_wholesaler/'. $wholesaler_detail->id );?>">
                                                                        <span><?php echo $wholesaler_detail->fullname; ?></span>
                                                                    </a>
                                                                </div>
                                                            </div>
