            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    ...
                    <div class="position-relative">
                        ...
                        <?php if (count($this->session->flashdata('password_login')) != NULL) : ?>
                            <div class="alert alert-info">
                                <?php echo($this->session->flashdata('password_login')); ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <?php echo form_open(); ?>
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                <label class="inline">
                                                    <a href="<?php echo base_url('users/forgot_password');?>" class="btn btn-sm btn-primary">
                                ...
                                <div class="toolbar clearfix">
                                    <div>
                                        <a href="<?php echo base_url('wholesaler/users/register') ; ?>" data-target="#forgot-box" class="forgot-password-link">
                                    ...
                                    <div>
                                        <a href="<?php echo base_url('retailer/users/register') ; ?>" data-target="#signup-box" class="user-signup-link">
                                            Register Retailer
